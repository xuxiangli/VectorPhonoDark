...
from vectorphonodark.rate import VDF, FormFactor, BinnedMcalI, BinnedRate
...
file_params_form_factor = {
    ...
    'hdf5': output_path+'test'+'.hdf5',
    'hdf5_group': 'form_factor/GaAs_hadrophilic_1MeV_128_25_25',
    'hdf5_data': 'data'
}
file_params_mcalI = {
    'hdf5': output_path+'test'+'.hdf5',
    'hdf5_group': 'mcalI/1MeV',
    'hdf5_data': 'data'
}

vdf = VDF(physics_params={}, numerics_params={})
# vdf.import_csv(filename=file_params_vdf['csv'])
vdf.import_hdf5(filename=file_params_vdf['hdf5'],
...
form_factor.import_hdf5(filename=file_params_form_factor['hdf5'],
